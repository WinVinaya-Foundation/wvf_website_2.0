...
import { whySensitization } from '../../../pages/involve/signLanguageContent';

/** Why Sensitization Matters Section — opens Part One, reframing exclusion as uninformed rather than malicious */
export default function WhySensitizationSection() {
  return (
    <SectionContainer labelledBy="why-sensitization-heading" id="get-sensitized">
      <Box
        sx={{
          position: 'relative',
          overflow: 'hidden',
