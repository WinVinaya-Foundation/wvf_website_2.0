...
import { howPartnershipWorks } from '../../../pages/involve/corporateEngagementContent';

/** How Partnership Works Section — a visual 4-step flow from consultation to ongoing support */
export default function HowPartnershipWorksSection() {
  return (
    <SectionContainer bgcolor="background.paper" labelledBy="how-partnership-works-heading">
      <SectionHeading
        eyebrow="A Clear, Simple Process"
        title={howPartnershipWorks.headline}
        description={howPartnershipWorks.description}
        align="center"
        titleId="how-partnership-works-heading"
      />
      ...
      >
        {howPartnershipWorks.steps.map((step, index) => (
          <Box
            key={step.stepNumber}
            sx={{
              position: 'relative',
          ...
          >
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
              ...
              {index < howPartnershipWorks.steps.length - 1 && (
                <Box
                  sx={{
